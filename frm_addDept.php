<div class="container">
  ...
  <div class="jumbotron">
    <div class="col-sm-8 mx-auto">
      <h1>บันทึกหน่วยงานผู้เบิก</h1>
      <form>
        <div class="form-row">
          <div class="form-group col-md-3">
            <label for="inputEmail4">รหัสหน่วยงาน</label>
            <input type="email" class="form-control" id="inputEmail4" readonly="" placeholder="รหัสหน่วยงาน">
          </div>
        <div class="form-group col-md-6">
          <label for="inputAddress">ชื่อหน่วยงาน</label>
          <input type="text" class="form-control" id="inputAddress" placeholder="ชื่อหน่วยงาน">
        </div>
