<div class="container">
  ...
  <div class="jumbotron">
    <div class="col-sm-8 mx-auto">
      <h1>บันทึกประเภทวัสดุ</h1>
      <form>
        <div class="form-row">
          <div class="form-group col-md-3">
            <label for="inputEmail4">รหัสประเภทวัสดุ</label>
            <input type="email" class="form-control" id="inputEmail4" readonly="" placeholder="รหัส">
          </div>

        <div class="form-group col-md-6">
          <label for="inputAddress">ประเภทวัสดุ</label>
          <input type="text" class="form-control" id="inputAddress" placeholder="ประเภทวัสดุ">
        </div>
      </div>
